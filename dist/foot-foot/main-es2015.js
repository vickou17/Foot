...
let AuthenticationService = class AuthenticationService {
    ...
    authenticate(user) {
        ...
        let body = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["URLSearchParams"]();
        body.append('username', user.username);
        body.append('password', user.password);
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
...
let ClassementComponent = class ClassementComponent {
};
...
let GroupesComponent = class GroupesComponent {
};
...
let ListeEquipeComponent = class ListeEquipeComponent {
    constructor(http) {
        this.http = http;
    }
};
ListeEquipeComponent.ctorParameters = () => [
...
let PostComponent = class PostComponent {
    ...
    ngOnInit() {
        this.postRepository
            .getList()
            .subscribe(data => this.posts = data, error => this.error = error.message);
    }
};
...
let RencontresComponent = class RencontresComponent {
    constructor() { }
    ngOnInit() {
    }
};
